...
, tournament: {
  ...
  , entry: {
      startDate: "16 Sep 2019"
    , stopDate: "17 Oct 2019"
...
, sheets: {
  ...
  , entries: {
    ...
    , publicFields: ["PlayerName", "RatingsCentralID", "Rating"
      , "SinglesDiv1", "SinglesDiv2", "SinglesDiv3", "SinglesDiv4", "SinglesDiv5", "SinglesJunior"
      , "DoublesDiv1", "DoublesDiv2a3", "DoublesDiv4", "DoublesDiv5aJunior"
      , "DoublesDiv1Partner", "DoublesDiv2a3Partner", "DoublesDiv4Partner", "DoublesDiv5aJuniorPartner"]
    }
  }
};
...
var App = (function (meta, env, tools) {
  ...
  var emailEntryConfirmation = function (data) {
    ...
    var body = "Hi " + data["PlayerName"].split(",")[1].trim() + ",\n\n"
      ...
      + "To update/withdraw your entry, please visit " + data["EditLink"] + "\n\n"
      + "To view your entry, please visit " + meta.tournament.entry.resourceUrl + "list\n\n"
  ...
  actions.create = function (e) {
    ...
    if (row.ok) {
      ...
      data["EditLink"] = meta.tournament.entry.resourceUrl + "edit/?PlayerName=" + data["PlayerName"] + "&dust=" + data["Dust"];
      data["EditLink"] = '=HYPERLINK("' + data["EditLink"] + '", "edit")';
